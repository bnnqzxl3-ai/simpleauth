...
public class ZoneMusic {
     ...
     * глушит старый трек у каждого слушателя и сбрасывает состояние, чтобы
     * на следующем тике всем тут же заиграл новый. Используется и ручным
     * меню (TrackSelectorScreenHandler), и автопереключателем по таймеру —
     * поведение в обоих случаях одинаковое и мгновенное.
     */
